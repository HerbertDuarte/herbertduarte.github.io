...
<template>
  ...
  <nav ref="mobileMenu"
    :class="`md:hidden flex fixed z-40 top-16 left-0 p-8 pt-2 justify-center items-center w-full bg-[#080808] flex-col gap-5 text-zinc-100 transition-all duration-500 border-b border-zinc-800 ${menuIsOpen ? 'translate-y-[0]' : 'translate-y-[-100vh]'}`">
