<template>
    <label id="theme-toggle-button">
        <input v-model="isDarkTheme" type="checkbox" id="toggle-theme">
...
#toggle-theme:checked+svg #container {
    fill: #2b4360;
}

/* move button to right when checked */
#toggle-theme:checked+svg #button {
...
#toggle-theme:checked+svg #cloud {
    opacity: 0;
}
...
#toggle-theme:checked+svg #stars {
    opacity: 1;
}
</style>