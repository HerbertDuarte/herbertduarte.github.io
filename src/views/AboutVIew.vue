...
import { Download, UserRoundPlusIcon } from 'lucide-vue-next';
</script>
<template>
  <section id="about">
    ...
    <div class="flex flex-col gap-8 justify-center items-center">
      ...
      />
      <a href="/public/donwloads/cv-herbert-duarte.pdf" download="Currículo Herbert Duarte.pdf" class="flex items-center gap-1.5 hover:text-purple-500 group mt-5 pr-2">
